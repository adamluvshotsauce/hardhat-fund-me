# Hardhat Fund Me
Learning the fundamentals of smart contract development using hardhat. 

This project demostrates how to write, test, and verify smart contracts.

## Quickstart
```shell
git clone https://github.com/adamluvshotsauce/hardhat-fund-me.git
cd hardhat-fund-me
yarn
```
